package ssf.iss.nus.restfortunecookie.services;
...
public class FortuneCookie {
	...
	public static final Integer NUM_OF_COOKIES = COOKIES.length;
	...
	// returns count amount of cookies
	public List<String> getCookies(Integer count) {
		assert (count > 0);
		Random random = new Random();
		List<String> cookieList = new LinkedList<>();
		while (count > 0) {
			cookieList.add(COOKIES[random.nextInt(NUM_OF_COOKIES)]);
			count--;
		}
		return cookieList;
	}
